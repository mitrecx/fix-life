...
def test_upload_quick_note_image_when_oss_disabled(client_authenticated: TestClient, monkeypatch):
...
def test_upload_quick_note_image_success(client_authenticated: TestClient, monkeypatch):
    monkeypatch.setattr(settings, "OSS_ENABLED", True)
